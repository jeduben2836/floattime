...
function from_candid_Color_n11(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n12(_uploadFile, _downloadFile, value);
}
function from_candid_OrderStatus_n9(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n10(_uploadFile, _downloadFile, value);
}
function from_candid_Order_n7(_uploadFile, _downloadFile, value) {
  return from_candid_record_n8(_uploadFile, _downloadFile, value);
}
function from_candid_StripeSessionStatus_n16(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n10(_uploadFile, _downloadFile, value) {
  return "Delivered" in value ? "Delivered" : "Shipped" in value ? "Shipped" : "Pending" in value ? "Pending" : value;
}
function from_candid_variant_n12(_uploadFile, _downloadFile, value) {
  return "Red" in value ? "Red" : "Blue" in value ? "Blue" : "Green" in value ? "Green" : "White" in value ? "White" : value;
}
...
function to_candid_Color_n3(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n4(_uploadFile, _downloadFile, value);
}
function to_candid_CreateOrderRequest_n5(_uploadFile, _downloadFile, value) {
...
function useGetOrderById(orderId) {
  const { actor, isFetching } = useActor(createActor);
  const backend = actor;
  return useQuery({
    queryKey: ["order", orderId],
    queryFn: async () => {
      if (!(backend == null ? void 0 : backend.getOrderById) || !orderId) return null;
...
function useCreateCheckoutSession() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (!(backend == null ? void 0 : backend.createCheckoutSession))
